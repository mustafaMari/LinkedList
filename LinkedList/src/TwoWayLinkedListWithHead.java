...
class TwoWayLinkedListWithHead<E> implements IList<E>{
    ...
    public String toStringReverse()
    {
        ...
        while (iter.hasNext()) retStr = new StringBuilder( iter.next() + " ");
        while (iter.hasPrevious()) retStr.append(" ").append(iter.previous());
    ...
    public String toString()
    {
        ...
        for (E e : this) s.append(e).append(" ");
        return s.toString();
